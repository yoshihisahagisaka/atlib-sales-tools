...
import {createSalesIntakeRouter} from './routes/salesIntake';
...
async function main(): Promise<void> {
  ...
  app.use('/api/admin/it-management-diagnosis',...adminAuthGate,createSalesIntakeRouter(new SalesIntakeRepo(pool)));
